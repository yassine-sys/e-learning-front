import { Component, OnInit } from '@angular/core';import Question from 'app/shared/models/Question';
...
@Component({
  selector: 'app-update-exam-question',
  templateUrl: './update-exam-question.component.html',
  styleUrls: ['./update-exam-question.component.css']
})
export class UpdateExamQuestionComponent implements OnInit {
